package net.astro.dlc.world.feature.trunkplacer;
...
public class BaobabTrunkPlacer extends MegaJungleTrunkPlacer {
    ...
    public BaobabTrunkPlacer(int p_70193_, int p_70194_, int p_70195_) {
    ...
    public List<FoliagePlacer.FoliageAttachment> placeTrunk(LevelSimulatedReader p_161852_, BiConsumer<BlockPos, BlockState> p_161853_, RandomSource p_161854_, int p_161855_, BlockPos p_161856_, TreeConfiguration p_161857_) {
