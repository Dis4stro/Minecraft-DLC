...
public class ModChestLootTables extends ChestLoot {
    ...
    private static final ResourceLocation CUSTOM_IGLOO_CHEST = new ResourceLocation(DLC.MOD_ID,"chests/custom_igloo_chest");

    @Override
    public void accept(BiConsumer<ResourceLocation, LootTable.Builder> p_124363_) {
        p_124363_.accept(CUSTOM_IGLOO_CHEST, LootTable.lootTable().withPool(LootPool.lootPool().setRolls(UniformGenerator.between(2.0F, 8.0F))
                ...
                .add(LootItem.lootTableItem(Items.WHEAT).setWeight(10)
                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 3.0F))))).withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
                .add(LootItem.lootTableItem(Items.GOLDEN_APPLE))
                .add(LootItem.lootTableItem(ModItems.ICE_MUSIC_DISC.get()).setWeight(2))));
    }
}
